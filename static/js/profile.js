...
<div class="main">
    ...
    <div class="user-quests">
        ...
        <div class="quest">
            <div class="info">
                <div class="task">
                    <h2>Заходи в игру 25 дней подряд</h2>
                </div>
                <div class="progress-bar">
                    <div class="progress">
                        <h2>4%</h2>
    ...
    <div class="slider">
        <div class="sections">
            <a id="main_link" href="/main">
                <div class="section">
                    <i class="material-symbols-outlined">home</i>
                    <span class="span-sec">Главная</span>
                </div>
            </a>
            <a href="/cases">
                <div class="section">
                    <i class="material-symbols-outlined">featured_seasonal_and_gifts</i>
                    <span class="span-sec">Кейсы</span>
                </div>
            </a>
            <a href="/profile">
                <div class="section active">
                    <i class="material-symbols-outlined">account_circle</i>
                    <span class="span-sec">Профиль</span>
                </div>
            </a>
        </div>
    </div>
