...
function showWinModal(gift) {
    ...
    document.getElementById('sell_btn').display = "block";
    ...
    if (gift) {
        ...
        if (gift.price){
            ...
            modal.querySelector('.holder').innerHTML = '<h2 class="cnt">Повезёт в другой раз</h2>';
            document.getElementById('sell_btn').display = "none";
        }
